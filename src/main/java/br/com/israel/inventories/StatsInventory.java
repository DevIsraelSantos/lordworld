...
public class StatsInventory {
        ...
        public void open(Player player, PlayerStats stats) {
                ...
                inventory.setItem(13,
                                createItem(Material.GOLDEN_APPLE, "§6🏆 Par ou Ímpar",
                                                List.of("§fVitórias: §a" + stats.getWins(),
                                                                "§fDerrotas: §c" + stats.getLosses())));

                inventory.setItem(15,
                                createItem(Material.REDSTONE_TORCH, "§6📺 Scoreboard",
                                                List.of("§fStatus: " + (stats.isScoreboardEnabled() ? "§aLigado"
                                                                : "§cDesligado"), "",
                                                                "§eClique para alternar")));

                inventory.setItem(22,
                                createItem(Material.NETHER_STAR, "§6📈 Taxa de Vitória",
                                                List.of("§f" + stats.getPercentage())));
